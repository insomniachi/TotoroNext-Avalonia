...
public class SettingsCard : TemplatedControl
{
    ...
    public static readonly StyledProperty<bool> NavigatesProperty =
        AvaloniaProperty.Register<SettingsCard, bool>(nameof(Navigates));

    /// <summary>
    ///     Defines the <see cref="Editor" /> property.
    /// </summary>
    public static readonly StyledProperty<Control> EditorProperty =
        AvaloniaProperty.Register<SettingsCard, Control>(nameof(Editor));

    /// <summary>
    ///     Defines the <see cref="Expands" /> property.
    /// </summary>
    public static readonly StyledProperty<bool> ExpandsProperty =
        AvaloniaProperty.Register<SettingsCard, bool>(nameof(Expands));

    /// <summary>
    ///     Defines the <see cref="Content" /> property.
    /// </summary>
    public static readonly StyledProperty<object?> ContentProperty =
        ContentControl.ContentProperty.AddOwner<SettingsCard>();

    /// <summary>
    ///     Defines the <see cref="NavigationCommand" /> property.
    /// </summary>
    public static readonly StyledProperty<ICommand?> NavigationCommandProperty =
        AvaloniaProperty.Register<SettingsCard, ICommand?>(nameof(NavigationCommand));

    /// <summary>
    ///     Defines the <see cref="IsExpanded" /> property.
    /// </summary>
    public static readonly StyledProperty<bool> IsExpandedProperty =
        Expander.IsExpandedProperty.AddOwner<SettingsCard>();
    ...
    public static readonly RoutedEvent<RoutedEventArgs> NavigationRequestedEvent =
        RoutedEvent.Register<SettingsCard, RoutedEventArgs>(nameof(NavigationRequested),
    ...
    /// <summary>
    ///     Specifies that <see cref="SettingsCard" /> will reveal hidden content
    /// </summary>
    public bool Expands
    {
    ...
    /// <summary>
    ///     Indicates whether the <see cref="SettingsCard" /> content is open
    /// </summary>
