...
public class SettingsViewModel : ModuleSettingsViewModel<Settings>
{
    ...
    {
        _listener.Start();
        await launcher.LaunchUriAsync(new Uri($"https://anilist.co/api/v2/oauth/authorize?client_id={Settings.ClientId}&redirect_uri={Settings.RedirectUrl}&response_type=code"));
    }
}
